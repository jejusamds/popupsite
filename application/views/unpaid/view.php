                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12">
                      <div id="bbs-contents">
                        <p>세부항목 : <span>{UNP_CATEGORY_DETAIL}</span> </p>
                        <p>단위 : <span>{UNP_UNIT}</span> </p>
                        <p>금액 : <span>{UNP_PRICE}</span> </p>
                        <p>비고 : <span>{UNP_MEMO}</span> </p>
                      </div>
                  </div>
                </div>
              </div>
        ...
        <script>
          $(document).ready(function(){
            ...
            $(".modify").click(function(e){
              e.stopPropagation();
              location.href = "{BASE_URL}index.php/manager/unpaid/write/"+unp_id;
            });
            ...
            $(".delete").click(function(e){
              ...
              if($res){
                var url = "{BASE_URL}index.php/manager/unpaid/request_delete";
                var post = {'unp_id' : unp_id};
