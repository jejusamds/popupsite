                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <colgroup>
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                            ...
                            <td style="text-align:center; vertical-align:middle;">{START_DATE}~{END_DATE}</td>
                            <td style="text-align:center; vertical-align:middle;">{IS_VIEW}</td>
                            <td style="text-align:center; vertical-align:middle;">
                              <button type="button" class="btn btn-default btn-xs order-up" data-id="{ID}" data-order="{ORD}"><i class="fa fa-arrow-up"></i></button>
                              <button type="button" class="btn btn-default btn-xs order-down" data-id="{ID}" data-order="{ORD}"><i class="fa fa-arrow-down"></i></button>
                            </td>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <a href="{BASE_URL}index.php/manager/popup/write"><button style="float:right;" type="button" class="btn btn-primary btn-sm">
                        <i class="fa fa-pencil"></i>
                        글쓰기
                      </button></a>
                    </div>
