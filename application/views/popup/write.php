            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{CURRENT_URL}" method="post" class="form-horizontal form-label-left" novalidate id="popup_form">
                            ...
                            <div class="item form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="pop_title" name="pop_title"
                                        class="form-control col-md-12 col-xs-12" placeholder="타이틀" required="required"
                                        value="{POP_TITLE}" />
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="pop_link" name="pop_link"
                                        class="form-control col-md-12 col-xs-12" placeholder="http://"
                                        value="{POP_LINK}" />
                                </div>
                            </div>
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="pop_start" name="pop_start" class="form-control datepicker"
                                        value="{POP_START}" />
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label for="pop_end">종료일</label>
                                    <input type="text" id="pop_end" name="pop_end" class="form-control datepicker"
                                        value="{POP_END}" />
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="number" id="pop_order" name="pop_order" class="form-control"
                                        value="{POP_ORDER}" />
                                </div>
                            </div>
                        </form>
                        ...
                        <!-- <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="{BASE_URL}index.php/request/image_upload" class="dropzone"
                                            drop-zone="" id="pop-file-dropzone123123">
                                        ...
                                        <div style="display:none;"
                                            class="pop-upload-progress text-center alert alert-info">
                                            <h2><i class="fa fa-refresh fa-spin"></i><strong> 파일을 업로드중 입니다.</strong>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
