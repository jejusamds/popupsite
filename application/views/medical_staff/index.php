          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>의료진 목록 <small> 사이트에 보여줄 의료진 정보를 관리합니다.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <colgroup>
                        ...
                        <thead>
                          <tr class="headings">
                            ...
                            <th style="text-align:center;" class="column-title">진료과목</th>
...
<td style="cursor:pointer; color:#999; font-weight:bolder; vertical-align:middle;" class="bbs-title">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <a href="{BASE_URL}index.php/manager/medical_staff/write"><button style="float:right;" type="button" class="btn btn-primary btn-sm">
                        <i class="fa fa-pencil"></i>
                        글쓰기
                      </button></a>
                    </div>
        ...
        <script>
          ...
          $(document).ready(function(){
            ...
            $(".bbs-title").click(function(){
              ...
              location.href = "{BASE_URL}index.php/manager/medical_staff/view/"+bbs_id;
            });


            $(".bbs-modify").click(function(){
              var bbs_id = $(this).parent().parent().find(".bbs-id").val();
              location.href = "{BASE_URL}index.php/manager/medical_staff/write/"+bbs_id;
            });
