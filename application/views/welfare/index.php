          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>사회복지프로그램 목록 <small> 사이트에 보여줄 사회복지프로그램을 관리합니다.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <colgroup>
                        ...
                        <thead>
                          <tr class="headings">
                            ...
                            <th style="text-align:center;" class="column-title">제목</th>
                            <th style="text-align:center;" class="column-title">작성일</th>
                            <th style="text-align:center;" class="column-title">조회수</th>
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                            ...
                            <td style="text-align:center; vertical-align:middle;"lass="a-center">{DATE}</td>
                            <td style="text-align:center; vertical-align:middle;" class="a-center">{VIEWS}</td>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <a href="{BASE_URL}index.php/manager/welfare/write"><button style="float:right;" type="button" class="btn btn-primary btn-sm">
                        <i class="fa fa-pencil"></i>
                        글쓰기
                      </button></a>
                    </div>
        ...
        <script>
          ...
          $(document).ready(function(){
            ...
            $(".bbs-title").click(function(){
              ...
              location.href = "{BASE_URL}index.php/manager/welfare/view/"+bbs_id;
            });


            $(".bbs-modify").click(function(){
              var bbs_id = $(this).parent().parent().find(".bbs-id").val();
              location.href = "{BASE_URL}index.php/manager/welfare/write/"+bbs_id;
            });
