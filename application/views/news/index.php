    ...
    <div class="container">
      <div class="row mt-2 mt-lg-5">
        <div class="col-12 justify-content-center text-center">
          <p class="sub_title_big mb-lg-2 mb-1 mt-3">언론보도</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="sub05_topimg" class="mt-lg-3 mt-2">
      <h2 class="col-7 ml-lg-5 sub_topimg_text text-center shaow wow animated fadeInDown" data-wow-duration="0.2s">
        “ <span>언론에 비친</span><br>부산금사요양병원입니다. "
      </h2>
            ...
            <tbody>
              ...
              <tr {IS_NOTICE}>
                ...
                <td class="left text-over">
                  <a href="{BASE_URL}index.php/news/detail/{ID}">
                    {TITLE} {IS_NEW}
                  </a>
                </td>
...
<script>
  $(document).ready(function(){
    ...
    $(".btn_search").click(function(){
      var url = "{BASE_URL}index.php/news/index/"+$("#search_type").val()+"/"+$("#search_value").val();
      location.href = url;
    });
  });
</script>