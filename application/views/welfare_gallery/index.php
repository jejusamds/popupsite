          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>사회복지프로그램 갤러리 목록 <small> 사회복지프로그램에서 보여질 이미지들을 관리합니다.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <div class="x_content">
                    <div class="row">
                      ...
                      <div style="margin-top:2em; margin-bottom:2em;" class="col-md-12 col-sm-12 col-xs-12">
                        <a href="{BASE_URL}index.php/manager/welfare_gallery/write"><button style="float:right;" type="button" class="btn btn-primary btn-sm">
        ...
        <script>
          ...
          $(document).ready(function(){
            ...
            $(".view").click(function(){
              ...
              location.href = "{BASE_URL}index.php/manager/welfare_gallery/view/"+gbbs_id;
            });

            $(".modify").click(function(e){
              e.stopPropagation();
              var gbbs_id = $(this).parent().parent().find(".gbbs_id").val();
              location.href = "{BASE_URL}index.php/manager/welfare_gallery/write/"+gbbs_id;
            });
            ...
            $(".delete").click(function(e){
              ...
              if($res){
                var gbbs_id = $(this).parent().parent().find(".gbbs_id").val();
                var url = "{BASE_URL}index.php/manager/welfare_gallery/request_delete";
