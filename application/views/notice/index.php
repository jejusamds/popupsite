          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>공지사항 목록 <small> 사이트에 보여줄 공지사항을 관리합니다.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <a href="{BASE_URL}index.php/manager/notice/write"><button style="float:right;" type="button" class="btn btn-primary btn-sm">
                        <i class="fa fa-pencil"></i>
                        글쓰기
                      </button></a>
                    </div>
        ...
        <script>
          ...
          $(document).ready(function(){
            ...
            $(".bbs-title").click(function(){
              ...
              location.href = "{BASE_URL}index.php/manager/notice/view/"+bbs_id;
            });


            $(".bbs-modify").click(function(){
              var bbs_id = $(this).parent().parent().find(".bbs-id").val();
              location.href = "{BASE_URL}index.php/manager/notice/write/"+bbs_id;
            });
