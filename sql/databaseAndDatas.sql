  `pop_link` varchar(255) DEFAULT '' COMMENT '링크 주소',
...
INSERT INTO `geumsa_popup` (`pop_id`, `pop_type`, `pop_title`, `pop_contents`, `pop_link`, `usr_id`, `pop_img`, `pop_top`, `pop_left`, `pop_start`, `pop_end`, `pop_order`, `is_view`, `is_delete`, `created`, `updated`) VALUES
